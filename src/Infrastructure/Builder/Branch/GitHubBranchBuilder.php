...
use GitPullRequest\Infrastructure\Builder\RemoteRepository\GitHubRemoteRepositoryBuilder;
use GitPullRequest\Infrastructure\Builder\RemoteRepository\RemoteRepositoryBuilderInterface;

/**
 * Build a branch from GitHub API.
 */
final class GitHubBranchBuilder extends AbstractBranchBuilder
{
    /**
    ...
    {
        return new GitHubRemoteRepositoryBuilder($repoApiURI);
    }
}
